Ext.define('CC.view.Viewport', {
	...
	items : [{
		region : 'north',
		html : '<div style="height:66px;width:100%;background:url(http://172.20.35.51:9080/yunguanshi/images/ygs/admin/headbg.png) repeat-x;"><div style="background:url(http://172.20.35.51:9080/yunguanshi/images/ygs/admin/adminlog.png) left center no-repeat;width:300px;height:60px;"></div><a id="logout">退出系统</a></div>',
		border : false
	}, {
		region : 'west',
		layout : 'accordion',
