 Ext.define('CC.view.index.panel', {
	...
	layout : 'border',
	title:'首页',
	html:'<div style="width:100%;height:100%;background:url(http://172.20.35.51:9080/yunguanshi/images/ygs/admin/home.png) center right no-repeat;"><p style="font-size:20px;margin-top:30px;margin-left:20px;font-weight:bold;color:#666666;font-family:宋体;">欢迎使用GitHub项目<p></div>',
	...
	items:[{
		...
		width : 480,
		border:false,
		html:'<div style="width:600px;height:400px;background:url(http://172.20.35.51:9080/yunguanshi/images/ygs/admin/home.png) left center  no-repeat;"></div>'
	}]
});
